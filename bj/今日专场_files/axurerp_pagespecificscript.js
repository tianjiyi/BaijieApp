...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('败姐直播.html');
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('专场产品列表.html');
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('败姐圈.html');
...
gv_vAlignTable['u11'] = 'top';gv_vAlignTable['u1'] = 'center';u2.tabIndex = 0;
